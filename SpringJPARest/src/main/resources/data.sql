...
insert into course(id, name, created_date, last_updated_date) 
values(10004, 'Spring Boot Micro Services Advanced', sysdate(), sysdate());
insert into course(id, name, created_date, last_updated_date) 
values(10005, 'Spring Boot Cloud Advanced', sysdate(), sysdate());
insert into course(id, name, created_date, last_updated_date) 
values(10006, 'Spring Boot Aop Advanced', sysdate(), sysdate());
